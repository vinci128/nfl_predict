...
def predict(
    ...
    season: int | None = typer.Option(None, help="Season year (default: inferred from data)."),
    week: int | None = typer.Option(None, help="Week number (default: inferred from data)."),
) -> None:
